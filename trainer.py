...
class Trainer:
    def __init__(self, options):
        ...
        datasets_dict = {"kitti": datasets.KITTIRAWDataset,
                         ...
                         "seasondepth": datasets.SeasonDepthRAWDataset
                         }
        self.dataset_k = datasets_dict["seasondepth"]
        fpath = os.path.join(os.path.dirname(__file__), "splits", self.opt.split, "{}_file.txt")

        #change trainset
        train_filenames_k = readlines(fpath.format("train_val_test"))
